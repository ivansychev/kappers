...
import ru.kappers.model.dto.leon.CompetitorDTO;
import ru.kappers.model.dto.leon.LeagueDTO;
import ru.kappers.model.dto.leon.LeonOddsDTO;
import ru.kappers.model.dto.leon.SportDTO;
...
public class LeonBetParserTest {
    ...
    private BetParser<LeonOddsDTO> parser = new LeonBetParser();
    ...
    public void getEventsWithOdds() {
        ...
        // check LeonOddsDTO
        final LeonOddsDTO oddsDTO = eventsWithOdds.get(0);
        final LeagueDTO leagueDTO = oddsDTO.getLeague();
        final List<CompetitorDTO> competitors = oddsDTO.getCompetitors();
...
//        assertThat(oddsDTO.getLastUpdated(), is(1557833759654L));
        ...
        CompetitorDTO tottenhamDTO = competitors.get(0);
        CompetitorDTO liverpoolDTO = competitors.get(1);
        if (tottenhamDTO.getId() != 281474976833057L) {
            CompetitorDTO tmp = tottenhamDTO;
        ...
        // check LeagueDTO
        final SportDTO sportDTO = leagueDTO.getSport();
    ...
    public void loadEventOdds() {
        final LeonOddsDTO oddsDTO = parser.loadEventOdds("/events/Soccer/281474976710675-Europe-UEFA-Champions-League/281474982732162-Ajax-Tottenham-Hotspur");
